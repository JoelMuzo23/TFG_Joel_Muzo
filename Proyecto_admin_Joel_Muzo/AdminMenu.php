                    ...
                    <div class="card"> 
                        ...
                        <div class="card-body"> 
                            ...
                            <div class="text-center">
                                <a href="Listado_Viajes.php" class="btn btn-outline-dark">Acceder</a>
                            </div>
                        </div>
                    </div> 
                </div>  
                <div class="col-md-6  col-12 mt-3"> 
                    <div class="card">  
                        ...
                        <div class="card-body"> 
                            ...
                            <div class="text-center">
                                <a href="Clientes.php" class="btn btn-outline-dark">Acceder</a>
                            </div>
                        </div>
                    </div> 
                </div>  
                <div class="col-md-12 mt-3 text-center">
                    <a href="CerrarAdmin.php" class="card-cerrar btn btn-outline-danger btn-block">Cerrar Sesión</a>
                 </div>
            </div>
        </div>
    <?php
