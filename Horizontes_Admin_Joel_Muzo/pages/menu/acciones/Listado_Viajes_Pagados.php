...
<head>
    ...
    <link rel="stylesheet" href="../../../estilos/Pagados.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <title>Viajes Pagados</title>
</head>
...
<body>
  ...
  <!-- 
    ...
    <div class="row mt-3">
        <div class="col-md-12">
            ...
            <div class="table-responsive" id="tabla-viajes">
                <p>Selecciona una categoría para ver los viajes pagados</p>
            </div> 
        </div>
    </div>
</div>
    ...
    <?php
        ...
        require_once("../../../scripts/script_pagados.php");
    ?>
