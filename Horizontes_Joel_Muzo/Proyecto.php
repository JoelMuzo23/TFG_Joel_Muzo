    ...
    // Funciones para añadir los datos del viaje a la base de datos
        ...
        // Funcion para reservar viajes culturales
            ...
            public function reservaCultural($id_cultura, $id_usuario, $fecha, $viajeros, $precio_total, $estado){
                ...
                $resultado = $this->conex -> prepare($sql);
                if($resultado -> execute($datos)){
                    echo '<div class="alert alert-success mt-3 rounded-pill text-center" role="alert"> Viaje Reservado correctamente <br> Ver mis reservas <a href="pages/menu_usuario/Mis_reservas.php"> Ver </a> </div>';
                }else{
                    echo '<div class="alert alert-danger mt-3 rounded-pill" role="alert"> Error</div>';
                }
            }
                    ...
                    while ($fila = $resultado->fetch()){
                        echo "
                            <tr>
                                ...
                                <td>". $fila["precio"] . "€</td>
                                <td> <a href='../pagos/PagoOferta.php?id=" . $fila['id_reserva'] . "' class='btn btn-outline-success btn-sm'>Pagar</a>
                            </tr>   
                        ";
                    }
                    echo "</tbody> </table>";
                    ...
                    while ($fila = $resultado->fetch()){
                        echo "
                            <tr>
                                ...
                                <td>". $fila["fecha_llegada"]  ."</td>
                                <td>". $fila["precio"]  ."€</td>
                                <td> <a href='../pagos/PagoHotel.php?id=" . $fila['id_reserva'] . "' class='btn btn-outline-success btn-sm'>Pagar</a>
                            </tr>   
                        ";
                    }
                    echo "</tbody> </table>";
                    ...
                    while ($fila = $resultado->fetch()){
                        echo "
                            <tr>
                                ...
                                <td>". $fila["fecha_llegada"]  ."</td>
                                <td>". $fila["precio"] ."€</td>
                                <td> <a href='../pagos/PagoCiudad.php?id=" . $fila['id_reserva'] . "' class='btn btn-outline-success btn-sm'>Pagar</a> </td>
                            </tr>   
                        ";
                    }
                    echo "</tbody> </table>";
                    ...
                    while ($fila = $resultado->fetch()){
                        echo "
                            <tr>
                                ...
                                <td>". $fila["fecha_llegada"]  ."</td>
                                <td>". $fila["precio"] ."€</td>
                                <td> <a href='../pagos/PagoPlaya.php?id=" . $fila['id_reserva'] . "' class='btn btn-outline-success btn-sm'>Pagar</a> </td>
                            </tr>   
                        ";
                    }
                    echo "</tbody> </table>";
                    ...
                    while ($fila = $resultado->fetch()){
                        echo "
                            <tr>
                                ...
                                <td>". $fila["fecha_llegada"]  ."</td>
                                <td>". $fila["precio"] ."€</td>
                                <td> <a href='../pagos/PagoEspacio.php?id=" . $fila['id_reserva'] . "' class='btn btn-outline-success btn-sm'>Pagar</a> </td>
                            </tr>   
                        ";
                    }
                    echo "</tbody> </table>";
                    ...
                    while ($fila = $resultado->fetch()){
                        echo "
                            <tr>
                                ...
                                <td>". $fila["fecha"]  ."</td>
                                <td>". $fila["precio"] ."€</td>
                                <td> <a href='../pagos/PagoCrucero.php?id=" . $fila['id_reserva'] . "' class='btn btn-outline-success btn-sm'>Pagar</a> </td>
                            </tr>   
                        ";
                    }
                    echo "</tbody> </table>";
                    ...
                    while ($fila = $resultado->fetch()){
                        echo "
                            <tr>
                                ...
                                <td>". $fila["fecha"]  ."</td>
                                <td>". $fila["precio"] ."€</td>
                                <td> <a href='../pagos/PagoCultural.php?id=" . $fila['id_reserva'] . "' class='btn btn-outline-success btn-sm'>Pagar</a> </td>
                            </tr>   
                        ";
                    }
                    echo "</tbody> </table>";
                    ...
                    while ($fila = $resultado->fetch()){
                        echo "
                            <tr>
                                ...
                                <td>". $fila["fecha"]  ."</td>
                                <td>". $fila["precio"] ."€</td>
                                <td> <a href='../pagos/PagoAventura.php?id=" . $fila['id_reserva'] . "' class='btn btn-outline-success btn-sm'>Pagar</a> </td>
                            </tr>   
                        ";
                    }
                    echo "</tbody> </table>";
    ...
    // Funciones para la zona de comentarios
        ...
        // Funcion para borrar el comentario del usuario.
            ...
            public function borrarComentario($id_comentario){
                ...
                $resultado = $this->conex -> prepare($sql);
                if($resultado -> execute($datos)){
                    header("location: pages/menu_usuario/Mis_comentarios.php");
                }else{
                    echo '<div class="alert alert-danger mt-3 rounded-pill" role="alert"> Error </div>';
                }
            }
