        ...
        <div class="row mt-2">
            <div class="col-12">
                ...
                if (isset($_SESSION["nombre"]) && isset($_SESSION["apellido"])) {
                    ...
                    if ($id_reserva) {
                        $pagoA = $proyecto->metodoPagoAventura($id_reserva); 
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (empty($error)) {
                        $recibo = new Proyecto();
                        $recibo -> pagoAventura($id_reserva, $estado);
                    }
                }
                ...
                <form action=<?=htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $id_reserva ?> method="post">
                    <div class="reserva-card text-center">
                        <div class="card-content">
                            <h2 class="card-title mt-2"><?= $pagoA['nombre'] ?></h2>
                            ...
                            <div class="card-details">
                                ...
                                <div id="formularioTarjeta" class="hidden mt-3">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-12">
                                                <img class="card-img-top" src="data:image/jpeg;base64, <?php echo base64_encode($pagoA['imagen']) ?>" style="width: 100%; height: 150px; object-fit: cover;">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="d-flex align-items-end mt-4 mb-2">
                                                <p class="h4"> <span class="pe-1"> <?= $pagoA['nombre'] ?> </span></p>
                                            </div>
                                            <div class="d-flex justify-content-between mb-2">
                                                <p class="textmuted">Viajeros:</p>
                                                <p class="fw-bold"><?= $pagoA['numero_viajeros'] ?></p>
                                            </div>
                                            <div class="d-flex justify-content-between mb-2">
                                                <p class="textmuted">Precio por persona:</p>
                                                <p class="fw-bold"><?= $pagoA['precio'] ?></p>
                                            </div>
                                            <div class="d-flex justify-content-between mb-2">
                                                <p class="textmuted">Precio total:</p>
                                                <p class="fw-bold"><?= $pagoA['precio'] * $pagoA['numero_viajeros'] ?></p>
                                            </div>
                                        </div>
                                        ...
                                        <input type="hidden" name="id_reserva" id="id_reserva" value=" <?= $pagoA["id_reserva"] ?> ">
                                ...
                                <div id="formularioBancario" class="hidden mt-3"> 
                                    <a href="pdf/PDFAventura.php?id=<?= $pagoA['id_reserva'] ?>" class="btn btn-outline-danger"> Generar PDF </a>
                                </div>
                            </div>
                        </div>
                    </div>
