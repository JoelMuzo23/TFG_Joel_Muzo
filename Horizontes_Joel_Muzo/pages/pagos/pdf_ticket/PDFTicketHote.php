...
if(isset($_GET['id'])) {
    ...
    $detalles_pdf = $proyecto->detallesPDFHote($id_reserva);
    ...
    if($detalles_pdf) {
        ...
        $pdf->Cell(0, 10, 'Fecha de Regreso: ' . $detalles_pdf['fecha_llegada'], 0, 1, 'L');
        $pdf->Cell(0, 10, 'Número de Personas: ' . $detalles_pdf['numero_viajeros'], 0, 1, 'L');
        $pdf->Cell(0, 10, 'Número de Habitaciones: ' . $detalles_pdf['numero_habitaciones'], 0, 1, 'L');
