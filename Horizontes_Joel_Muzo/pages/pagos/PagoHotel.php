        ...
        <div class="row mt-2">
            ...
            <div class="col-12">
                ...
                if (isset($_SESSION["nombre"]) && isset($_SESSION["apellido"])) {
                    ...
                    if ($id_reserva) {
                        $pagoH = $proyecto->metodoPagoHotel($id_reserva);   
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (empty($error)) {
                        $recibo = new Proyecto();
                        $recibo -> pagoHotel($id_reserva, $estado);
                    }
                }
                ...
                <form action=<?=htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $id_reserva ?> method="post">
                    <div class="reserva-card text-center">
                        <div class="card-content">
                            <h2 class="card-title mt-2"><?= $pagoH['nombre'] ?></h2>
                                <div class="card-details ">
                                    <h6 class="text-secondary">Fecha Salida:</h6>
                                    <p> <?= $pagoH['fecha_salida'] ?> </p>
                                    <h6 class="text-secondary">Fecha Llegada:</h6>
                                    <p> <?= $pagoH['fecha_llegada'] ?> </p>
                                </div>
                            ...
                            <div class="card-details">
                                ...
                                <div id="formularioTarjeta" class="hidden mt-3">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-12">
                                                <img class="card-img-top" src="data:image/jpeg;base64, <?php echo base64_encode($pagoH['imagen']) ?>" style="width: 100%; height: 150px; object-fit: cover;">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="d-flex align-items-end mt-4 mb-2">
                                                <p class="h4"> <span class="pe-1"> <?= $pagoH['nombre'] ?> </span></p>
                                            </div>
                                            <div class="d-flex justify-content-between mb-2">
                                                <p class="textmuted">Viajeros:</p>
                                                <p class="fw-bold"><?= $pagoH['numero_viajeros'] ?> Personas</p>
                                            </div>
                                            <div class="d-flex justify-content-between mb-2">
                                                <p class="textmuted">Numero de habitaciones:</p>
                                                <p class="fw-bold"><?= $pagoH['numero_habitaciones'] ?> Habitaciones</p>
                                            </div>
                                            <div class="d-flex justify-content-between mb-2">
                                                <p class="textmuted">Precio por persona:</p>
                                                <p class="fw-bold"><?= $pagoH['precio'] ?> €</p>
                                            </div>
                                            <div class="d-flex justify-content-between mb-2">
                                                <p class="textmuted">Precio total: <small>(IVA incluido)</small></p>
                                                <p class="fw-bold"><?= $pagoH['precio_total'] ?> €</p>
                                            </div>
                                        </div>
                                        ...
                                        <input type="hidden" name="id_reserva" id="id_reserva" value=" <?= $pagoH["id_reserva"] ?> ">
                                ...
                                <div id="formularioBancario" class="hidden mt-3"> 
                                    <a href="pdf/PDFHotel.php?id=<?= $pagoH['id_reserva'] ?>" class="btn btn-outline-danger"> Generar PDF </a>
                                </div>
                            </div>
                        </div>
                    </div>
