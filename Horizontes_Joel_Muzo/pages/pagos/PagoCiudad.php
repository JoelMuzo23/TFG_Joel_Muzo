        ...
        <div class="row mt-2">
            ...
            <div class="col-12">
                ...
                if (isset($_SESSION["nombre"]) && isset($_SESSION["apellido"])) {
                    ...
                    if ($id_reserva) {
                        $pagoC = $proyecto->metodoPagoCiudad($id_reserva);   
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (empty($error)) {
                        $recibo = new Proyecto();
                        $recibo -> pagoCiudad($id_reserva, $estado);
                    }
                }
                        ...
                        <div class="card-content">
                            <h2 class="card-title mt-2"><?= $pagoC['nombre'] ?></h2>
                                <div class="card-details ">
                                    ...
                                    <p> <?= $pagoC['fecha_salida'] ?> </p>
                                    <h6 class="text-secondary">Fecha Llegada:</h6>
                                    <p> <?= $pagoC['fecha_llegada'] ?> </p>
                                </div>
                            ...
                            <div class="card-details">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="d-flex justify-content-between mb-2">
                                                ...
                                                <p class="fw-bold"><?= $pagoC['numero_viajeros'] ?> Personas</p>
                                            </div>
                                            <div class="d-flex justify-content-between mb-2">
                                            ...
                                            <div class="d-flex justify-content-between mb-2">
                                                ...
                                                <p class="fw-bold"><?= $pagoC['precio_total']?> €</p>
                                            </div>
                                        </div>
                                ...
                                <div id="formularioBancario" class="hidden mt-3"> 
                                    <a href="pdf/PDFCiudad.php?id=<?= $pagoC['id_reserva'] ?>" class="btn btn-outline-danger"> Generar PDF </a>
                                </div>
                            </div>
                        </div>
                    </div>
