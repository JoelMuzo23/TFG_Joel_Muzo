...
<head>
    ...
    <title>Disponibilidad del Hotal</title>
</head>
<body>
    ...
    <div class="container mt-3">
        <div class="row">
            <?php
                /*
                    Una vez el usuario a iniciado sesion se llamara a la funcion reservaHotel() donde mediante el id del
                ...
                */
                if (isset($_SESSION["nombre"]) && isset($_SESSION["apellido"])) {
                    ...
                    if ($id_hotel) {
                        $reserva = $proyecto->dispoHotel($id_hotel);
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if(!empty($_POST["id_hotel"])){
                        $id_hotel = limpiar($_POST["id_hotel"]);
                    }
                    ...
                    if(!empty($_POST["habitaciones"])){
                        $habitacion = limpiar($_POST["habitaciones"]);
                    }
                    ...
                    if (empty($error)) {
                        ...
                        $reservas -> reservaHotel($id_hotel, $id_usuario, $fecha_salida,  $fecha_llegada, $viajeros, $habitacion, $precio_total, $estado);
                    }
                }
            ?>  

            <div class="reserva-card"> 
                <h3 class="card-title text-center mt-2 text-secondary"><?= $reserva["nombre"] . " - ". $reserva["ciudad"] ?></h3>
                <div class="card-body">
                    <div class="row mt-3">
                    ...
                    <p class="text-center mt-4"> <?= $reserva["servicio"] ?></p>

                    <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $id_hotel ?>" method='post'>  
                        <div class="form-group">
                            <h4 class="card-title text-center mt-5 text-secondary"> Selecciona la fecha de entrada </h4>
                        ...
                        <div class="form-group mb-4">
                            <h4 class="card-title text-center mt-3 text-secondary">Selecciona el número de huéspedes</h4>
                        ...
                        <div class="form-group mb-4 mt-5">
                            <h4 class="card-title text-center mt-3 text-secondary">Selecciona el número de habitaciones</h4>
                            <div class="counter-container">
                                <button type="button" class="counter-button btn btn-outline-dark" id="decrementha-btn">-</button>
                                <input type="number" class="counter-input form-control" id="habitaciones" name="habitaciones" value="1" min="1" max="10" readonly>
                                <button type="button" class="counter-button btn btn-outline-dark" id="incrementha-btn">+</button>
                            </div>
                        </div>

                        <input type="hidden" name="id_hotel" id="id_hotel" value=" <?= $reserva["id_hotel"] ?> ">
                        ...
                        <div class="text-center">
                            ...
                            <a href="../Hoteles.php" class="btn btn-outline-danger"> Volver</a>
                        </div>
                    </form>
            ...
            <?php
                    ...
                    Debes de seleccionar un hotel para ver su disponibilidad <br>
