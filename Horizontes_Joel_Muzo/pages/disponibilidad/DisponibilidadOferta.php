    ...
    <div class="container mt-3">
        <div class="row">
                ...
                */
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (empty($error)) {
                        ...
                        $reservas -> reservaOferta($id_oferta, $id_usuario, $fecha_salida,  $fecha_llegada, $viajeros, $precio_total, $estado);
                    }
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $id_oferta ?>" method='post'>
                            ...
                            <div class="text-center">
                                ...
                                <a href="../Ofertas.php" class="btn btn-outline-danger"> Volver</a>
                            </div>
                        </form>
            ...
            <?php
                    ...
                    Debes de seleccionar una oferta para ver su disponibilidad <br>
