...
<head>
    ...
    <title>Disponibilidad de la Playa</title>
</head>
<body>
    ...
    <div class="container mt-3">
        <div class="row">
            <?php
                /*
                    Una vez el usuario a iniciado sesion se llamara a la funcion reservaPlaya() donde mediante el id del
                ...
                */
                if (isset($_SESSION["nombre"]) && isset($_SESSION["apellido"])) {
                    ...
                    $id_playa = isset($_GET["id"]) ? $_GET["id"] : null;
                    if ($id_playa) {
                        $reserva = $proyecto->dispoPlaya($id_playa);
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if(!empty($_POST["id_playa"])){
                        $id_playa = limpiar($_POST["id_playa"]);
                    }
                    ...
                    if (empty($error)) {
                        ...
                        $reservas -> reservaPlaya($id_playa, $id_usuario, $fecha_salida, $fecha_llegada, $viajeros, $precio_total, $estado);
                    }
                }
            ?>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="../categorias/Playas.php">Playas</a></li>
            ...
            <div class="reserva-card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $id_playa ?>" method="post">
                        ...
                        <input type="hidden" name="id_playa" value=" <?= $reserva["id_playa"] ?>">
                        ...
                        <div class="text-center">
                            ...
                            <a href="../categorias/Playas.php" class="btn btn-outline-danger"> Volver</a>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <?php
                    ...
                    Debes de seleccionar un viaje a la playa para ver su disponibilidad <br>
                    <a href='../categorias/Playas.php'>Volver</a>
                </div>";
                }
            } else {
