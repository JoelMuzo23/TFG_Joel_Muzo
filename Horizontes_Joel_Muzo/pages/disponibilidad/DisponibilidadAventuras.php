...
<head>
    ...
    <title>Disponibilidad de Aventuras</title>
</head>
<body>
   ...
   <!--
    ...
    <div class="container mt-3">
        <div class="row">
                <?php
                    /*
                        Una vez el usuario a iniciado sesion se llamara a la funcion reservaAventura() donde mediante el id del
                    ...
                    */
                    if (isset($_SESSION["nombre"]) && isset($_SESSION["apellido"])) {
                        require_once("../../Proyecto.php");
                            ...
                            $id_aventura = isset($_GET["id"]) ? $_GET["id"] : null;
                            if ($id_aventura) {
                                $reserva = $proyecto->dispoAventura($id_aventura);
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            if(!empty($_POST["id_aventura"])){
                                $id_aventura = limpiar($_POST["id_aventura"]);
                            }
                            ...
                            if (empty($error)) {
                                ...
                                $reservas -> reservaAventura($id_aventura, $id_usuario, $fecha, $viajeros, $precio_total, $estado);
                            }
                        }
                ?>
                <nav aria-label="breadcrumb" class="bread">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="../categorias/Aventuras.php">Aventuras</a></li>
                ...
                <div class="reserva-card">
                    ...
                    <div class="card-body">        
                        ...
                        <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $id_aventura ?>" method="post">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="counter-container">
                                    ...
                                    <input type="number" class="counter-input form-control bg-white" id="viajeros" name="viajeros" value="1" min="1" max="10" readonly>
                                    <button type="button" class="counter-button btn btn-outline-dark" id="increment-btn">+</button>
                                </div>
                            </div>
                            
                            <input type="hidden" name="id_aventura" value=" <?= $reserva["id_aventura"] ?> ">
                            ...
                            <div class="text-center">
                                ...
                                <a href="../categorias/Aventuras.php" class="btn btn-outline-danger"> Volver</a>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <?php
                    ...
                    Debes de seleccionar un viaje de aventura para ver su disponibilidad <br>
                    <a href='../categorias/Aventuras.php'>Volver</a>
                </div>";
                }
            } else {
