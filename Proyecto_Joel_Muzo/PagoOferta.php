        ...
        <div class="row mt-2">
            <div class="col-12">
                ...
                if (isset($_SESSION["nombre"]) && isset($_SESSION["apellido"])) {
                    ...
                    if ($id_reserva) {
                        $pagoO = $proyecto->pagoOferta($id_reserva);          
                ?>
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-details">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="d-flex justify-content-between mb-2">
                                                ...
                                                <p class="fw-bold"><?= $pagoO['precio'] * $pagoO['numero_viajeros'] ?></p>
                                            </div>
                                        </div>
                                ...
                                <div id="formularioBancario" class="hidden mt-3"> 
                                    <a href="PDFOferta.php?id=<?= $pagoO['id_reserva'] ?>" class="btn btn-outline-danger"> Generar PDF </a>
                                </div>
                            </div>
                        </div>
                    </div>
