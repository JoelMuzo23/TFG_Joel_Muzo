...
<head>
    ...
    <title>Disponibilidad de Oferta</title>
</head>
<body>

    <!-- Aquí se muestra una barra de navegación que incluye un logo y un botón para volver al menú del administrador -->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end ml-3" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <div class="boton"> <a class="nav-link" aria-current="page" href="Ofertas.php">Volver</a> </div>
                    </li>
                </ul>
            </div> 
        </div>
            ...
            <?php
                ...
                */
                ...
                if (isset($_SESSION["nombre"]) && isset($_SESSION["apellido"])) {
                    ...
                    $id_oferta = isset($_GET['id']) ? $_GET['id'] : null;
                    if ($id_oferta) {
                        $reserva = $proyecto->dispoOfertas($id_oferta);
                    }else {
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if(!empty($_POST["id_oferta"])){
                        $id_oferta = limpiar($_POST["id_oferta"]);
                    }
                    ...
                    if (empty($error)) {
                        ...
                        $reservas -> reservaOferta($id_oferta, $id_usuario, $fecha_salida,  $fecha_llegada, $viajeros);
                    }
            ...
            ?>
                <div class="reserva-card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $id_oferta ?>" method='post'>
                            ...
                            <input type="hidden" name="id_oferta" id="id_oferta" value="<?= $id_oferta ?>">
