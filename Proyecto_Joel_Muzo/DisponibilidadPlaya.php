    ...
    <nav class="navbar navbar-expand-lg bg-black">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end ml-3" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                    <div class="boton"> <a class="nav-link" aria-current="page" href="Playas.php">Volver</a> </div>
                </li>
                </ul>
            </div> 
        </div>
                ...
                */
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    if (empty($error)) {
                        ...
                        $reservas -> reservaPlaya($id_playa, $id_usuario, $fecha_salida, $fecha_llegada, $viajeros);
                    }
                }
            ?>
