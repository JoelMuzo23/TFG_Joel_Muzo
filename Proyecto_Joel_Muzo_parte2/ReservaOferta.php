        ...
        <div class="row">
            <?php
                ...
                if (isset($_SESSION["nombre"]) && isset($_SESSION["apellido"])) {
                    ...
                    /*
                        Una vez el usuario a iniciado sesion se llamara a la funcion reservaOfertas() donde mediante el id del
                    ...
                    */
                    ...
                    if ($id_oferta) {
                        $reserva->reservaOfertas($id_oferta);
                    }
                } else {
